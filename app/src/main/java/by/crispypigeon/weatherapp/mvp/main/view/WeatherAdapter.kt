...
class WeatherAdapter(private val items: List<WeatherDbItem>) : RecyclerView.Adapter<WeatherAdapter.WeatherHolder>() {
    ...
    override fun onBindViewHolder(holder: WeatherHolder, position: Int) {
        ...
        holder.timeTextView.text = currentItem.time.toString()
